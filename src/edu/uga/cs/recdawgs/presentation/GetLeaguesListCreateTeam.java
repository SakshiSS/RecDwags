...
/**
 * Servlet implementation class GetLeaguesListCreateTeam
 */
@WebServlet("/GetLeaguesListCreateTeam")
public class GetLeaguesListCreateTeam extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 static String templateDir = "WEB-INF/templates";
	  static String resultTemplateName = "CreateTeamLeaguesList.ftl"; // get the template file
     ...
     */
    public GetLeaguesListCreateTeam() {
        super();
...
//Preparing the http response
        ...
        try{
        	...
        	root.put("captain_name", studentName);
