...
/**
 * Servlet implementation class GetLeagues
 */
@WebServlet("/GetLeagues")
public class GetLeagues extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 static String templateDir = "WEB-INF/templates";
	  static String resultTemplateName = "GetLeagues-Result.ftl"; // get the template file
