...
/**
 * Servlet implementation class ListAwayHomeTeamSchedule
 */
@WebServlet("/ListAwayHomeTeamSchedule")
public class ListAwayHomeTeamSchedule extends HttpServlet {
     ...
     */
	 static  String         templateDir = "WEB-INF/templates";
	    static  String         resultTemplateName = "HomeAwayTeamSchedule-Result.ftl";
