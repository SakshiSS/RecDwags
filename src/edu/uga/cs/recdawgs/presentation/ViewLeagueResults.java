...
/**
 * Servlet implementation class ViewLeagueResults
 */
@WebServlet("/ViewLeagueResults")
public class ViewLeagueResults extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String templateDir = "WEB-INF/templates";
    static String resultTemplateName = "ViewLeagues-Result.ftl";
...
//        		session_League_Id.setAttribute("LeagueId",league_id  );
        ...
        try{
        	resultTemplate.process(leagueMap, toClient );
