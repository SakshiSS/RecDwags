...
/**
 * Servlet implementation class LeaveTeam
 */
@WebServlet("/LeaveTeam")
public class LeaveTeam extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static  String         templateDir = "WEB-INF/templates";
	static  String         resultTemplateName = "LeaveTeam-Result.ftl";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /*System.out.println("logiclayer and session successfull");
        String tName=request.getParameter("txtTeamName");
		long id=18;*/
		logicLayer.leaveTeam(id,tName);
