...
<body>
<form name="form1" action="ListTeams" method="Get">
 ...
 <#list leagues as league>
  <tr>
   <td valign="top"><b><font size="+1"><font color="#663366"><button
                    style="font-size:15px" name="btnLeagueId" value=${league[1]}>${league[1]}</button></font></font></b></td>
...
<p><p>Back to the <a href="League_Home.html">LeagueHomePage</a>
